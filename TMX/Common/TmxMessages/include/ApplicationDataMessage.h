...
#include "ApplicationDataMessageTypes.h"
...
public:
	...
	ApplicationDataMessage(std::string id, appmessage::ApplicationId appId, //std::string eventID,
	...
	static constexpr const char* MessageSubType = "Data";
