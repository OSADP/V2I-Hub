...
--
DROP DATABASE `IVP`;
CREATE DATABASE `IVP` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `IVP`;
...
--
-- Constraints for table `installedPlugin`
--
ALTER TABLE `installedPlugin`
  ADD CONSTRAINT `installedPlugin_ibfk_2` FOREIGN KEY (`pluginId`) REFERENCES `plugin` (`id`);

--
-- Constraints for table `messageActivity`
--
ALTER TABLE `messageActivity`
  ADD CONSTRAINT `messageActivity_ibfk_1` FOREIGN KEY (`messageTypeId`) REFERENCES `messageType` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `messageActivity_ibfk_2` FOREIGN KEY (`pluginId`) REFERENCES `plugin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pluginConfigurationParameter`
--
ALTER TABLE `pluginConfigurationParameter`
  ADD CONSTRAINT `pluginConfigurationParameter_ibfk_1` FOREIGN KEY (`pluginId`) REFERENCES `plugin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pluginMessageMap`
--
ALTER TABLE `pluginMessageMap`
  ADD CONSTRAINT `pluginMessageMap_ibfk_2` FOREIGN KEY (`messageTypeId`) REFERENCES `messageType` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pluginMessageMap_ibfk_1` FOREIGN KEY (`pluginId`) REFERENCES `plugin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pluginStatus`
--
ALTER TABLE `pluginStatus`
  ADD CONSTRAINT `pluginStatus_ibfk_2` FOREIGN KEY (`pluginId`) REFERENCES `plugin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
