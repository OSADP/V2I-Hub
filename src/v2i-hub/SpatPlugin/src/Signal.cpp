...
void SignalPhase::UpdatePhase(PhaseStatus newPhaseStatus)
    {
    /*
...
SignalPhase& SignalPhase::operator=(SignalPhase& newPhase)
    {
    for(int i=0;i<2;i++)
        {
...
void SignalPhase::RecordPhase(char *filename)
    {
    fstream fs;
